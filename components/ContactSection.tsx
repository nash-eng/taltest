      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
          ...
          <div className="lg:w-1/2 flex flex-col justify-center">
             <div className="inline-block px-3 py-1 mb-6 text-xs font-semibold tracking-wider text-brand-secondary uppercase bg-pink-100 rounded-full w-fit border border-pink-200">
               Get in touch
             </div>
            <h2 className="text-4xl md:text-6xl font-extrabold text-slate-900 mb-6 leading-tight font-display">
              Increase Quality by <span className="relative inline-block text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-secondary">
                Talking
            ...
            <div className="relative">
                ...
                <div className="bg-white p-4 rounded-2xl rounded-tl-none shadow-xl border border-slate-100 max-w-sm mb-4 transform hover:scale-105 transition-transform duration-300">
                 ...
                 <div className="bg-slate-900 p-4 rounded-2xl rounded-tr-none shadow-xl max-w-sm ml-auto transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="lg:w-1/2">
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-2xl shadow-purple-900/10 border border-slate-100">
              <h3 className="text-2xl font-bold text-slate-900 mb-6">Reach candidates at the right time</h3>
